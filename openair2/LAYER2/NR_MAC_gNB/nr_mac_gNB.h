...
} nr_rc_slice_policy_t;

typedef struct {
  pthread_mutex_t lock;
  int n_policy;
  nr_rc_slice_policy_t policy[MAX_RC_SLICE_POLICY];
} nr_rc_slice_policy_store_t;
...
typedef struct gNB_MAC_INST_s {
  ...
  nr_rc_slice_policy_store_t rc_slice_policy;
